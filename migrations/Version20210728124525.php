 ...
 */
final class Version20210728124525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device_users (device_users_id INT AUTO_INCREMENT NOT NULL, device_id INT NOT NULL, user_id INT NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, INDEX device_id (device_id), INDEX user_id (user_id), PRIMARY KEY(device_users_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
